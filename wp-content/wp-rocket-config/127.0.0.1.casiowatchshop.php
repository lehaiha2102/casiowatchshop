...
$rocket_cookie_hash = 'ed8f64145deca499ed4d559b3fcacf81';
$rocket_logged_in_cookie = 'wordpress_logged_in_ed8f64145deca499ed4d559b3fcacf81';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_secret_cache_key = '63d8a0eb51afa098510659';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 0;
$rocket_cache_webp = 0;
$rocket_cache_ssl = 1;
$rocket_cache_reject_uri = '/casiowatchshop(/(.+/)?feed/?.+/?|/(?:.+/)?embed/|/thanh-toan/(.*)|/gio-hang/|/tai-khoan/(.*)|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$))';
